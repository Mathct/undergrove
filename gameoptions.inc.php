 ...
 * gameoptions.inc.php
 *
 * undergrove game options description
 * 
 ...
 *        with the same ID (see "initGameStateLabels" in undergrove.game.php)
 *
...
////// a enlever pour le spectateur

$game_preferences = array(
    100 => array(
            'name' => totranslate('Display the player board'),
