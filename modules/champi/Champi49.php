...
class Champi49 extends Champi
{
    ...
    public function init($parg1, $parg2, $varg1, $varg2)
    {
        ...
        if ($parg1 != null)
        {
            ...
            undergrove::$instance->notifyAllPlayers("message",clienttranslate( '${player_name} activated ${name1} and copies ${name2}' ), array(
                ...
                'name2' => $this->listechampi[49]["name"],   //////////// changer le type
        ...
        {
            self::DbQuery( "UPDATE champignon set carbone = carbone WHERE card_type = 49" );        //////////// changer le type et nbre carbone
            undergrove::$instance->notifyAllPlayers("message",clienttranslate( '${player_name} activated ${name}' ), array(

                'i18n' => array( 'name'),
                'player_name' => $this->player_name,
                'name' => $this->listechampi[49]["name"],   //////////// changer le type
        ...
        undergrove::$instance->addPendingTarget($this->player_id, "Champi49", "Champi49Step1");
    }

    public function argChampi49Step1($parg1, $parg2)
    {
        $ret = array();
        $ret["selectable"] = array();
        $ret['buttons'] = array();
    ...
    public function Champi49Step1($parg1, $parg2, $varg1, $varg2)
    {
        
        undergrove::$instance->addPendingTarget($this->player_id, "Champi49", "Champi49Step2", $varg1);
    }

    public function argChampi49Step2($parg1, $parg2)
    {
        $ret = array();
        $ret["selectable"] = array();
        $ret['buttons'] = array();
    ...
    public function Champi49Step2($parg1, $parg2, $varg1, $varg2)
    {
        ...
        if ($absorb == 0)
        {
            ...
            $plusPetiteValeur = min($total)-2;
            if($plusPetiteValeur <=0)
            {
                $circle = "circle_".$explodesemi[1]."_".$explodesemi[2];
                self::DbQuery( "UPDATE foret set carbone = carbone +1  WHERE location = '{$circle}'" );
                self::DbQuery( "UPDATE champignon set carbone = carbone -1  WHERE card_id = {$explodechampi[1]}" );
            ...
            undergrove::$instance->addPendingTarget($this->player_id, "Champi49", "Champi49Step3", $parg1, $varg1);
            }
    ...
    function argChampi49Step3($parg1, $parg2)
{
    $ret = array();
    $ret["selectable"] = array();
    $ret['buttons'] = array();
...
function Champi49Step3($parg1, $parg2, $varg1, $varg2)
{
    ...
    else
    {
        $nbre=undergrove::$instance->getGameStateValue('variable1')+1;
        undergrove::$instance->setGameStateValue('variable1', $nbre);
        undergrove::$instance->addPendingTarget($this->player_id, "Champi49", "Champi49Step3", $parg1, $parg2);
