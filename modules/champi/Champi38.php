...
class Champi38 extends Champi
{
    ...
    public function init($parg1, $parg2, $varg1, $varg2)
    {
        ...
        if ($parg1 != null)
        {
            ...
            undergrove::$instance->notifyAllPlayers("message",clienttranslate( '${player_name} activated ${name1} and copies ${name2}' ), array(
                ...
                'name2' => $this->listechampi[38]["name"],   //////////// changer le type
        ...
        {
            self::DbQuery( "UPDATE champignon set carbone = carbone + 2  WHERE card_type = 38" );        //////////// changer le type et nbre carbone
            undergrove::$instance->notifyAllPlayers("message",clienttranslate( '${player_name} activated ${name}' ), array(

                'i18n' => array( 'name'),
                'player_name' => $this->player_name,
                'name' => $this->listechampi[38]["name"],   //////////// changer le type
        ...
        undergrove::$instance->addPendingTarget($this->player_id, "Champi38", "Champi38Step1");
    }

    public function argChampi38Step1($parg1, $parg2)
    {
        $ret = array();
        $ret["selectable"] = array();
        $ret['buttons'] = array();
    ...
    public function Champi38Step1($parg1, $parg2, $varg1, $varg2)
    {
        ...
        if ($a == 0)
        {
            $recupsquare = self::getUniqueValueFromDB("SELECT card_location location FROM champignon WHERE card_type = 38");
        }
        else
        {
        ...
        foreach ($recupminisquare as $id)
        {
            ...
            if (($explodeminisquare[1]==$explodesquare[1]) && ($explodeminisquare[2]==$explodesquare[2]) && ($explodeminisquare[3]==$explodesemi[1]) && ($explodeminisquare[4]==$explodesemi[2]))
            {
                ...
                if ($a == 0)
                {
                self::DbQuery( "UPDATE champignon set carbone = carbone -1  WHERE card_type = 38" );
                }
                else
                {
                ...
                undergrove::$instance->addPendingTarget($this->player_id, "Champi38", "Champi38SecondAbsorb", $varg1);
        ...
        if ($absorb == 0)
        {
            ...
            undergrove::$instance->addPendingTarget($this->player_id, "Champi38", "Champi38Step2", $varg1);
    ...
    function argChampi38Step2($parg1, $parg2)
    {
        $ret = array();
        $ret["selectable"] = array();
        $ret['buttons'] = array();
    ...
    function Champi38Step2($parg1, $parg2, $varg1, $varg2)
    {
    ...
    
        {
            ...
            undergrove::$instance->addPendingTarget($this->player_id, "Champi38", "Champi38SecondAbsorb", $parg1);
        ...
        else
        {
            $nbre=undergrove::$instance->getGameStateValue('variable1')+1;
            undergrove::$instance->setGameStateValue('variable1', $nbre);
            undergrove::$instance->addPendingTarget($this->player_id, "Champi38", "Champi38Step2", $parg1);
        ...
        public function argChampi38SecondAbsorb($parg1, $parg2)
    {
        $ret = array();
        $ret["selectable"] = array();
        $ret['buttons'] = array();
    ...
    public function Champi38SecondAbsorb($parg1, $parg2, $varg1, $varg2)
    {
        ...
        if ($absorb == 0)
        {
            ...
            undergrove::$instance->addPendingTarget($this->player_id, "Champi38", "Champi38SecondAbsorbStep2", $varg1);
    ...
    function argChampi38SecondAbsorbStep2($parg1, $parg2)
    {
        $ret = array();
        $ret["selectable"] = array();
        $ret['buttons'] = array();
    ...
    function Champi38SecondAbsorbStep2($parg1, $parg2, $varg1, $varg2)
    {
        ...
        else
        {
            $nbre=undergrove::$instance->getGameStateValue('variable1')+1;
            undergrove::$instance->setGameStateValue('variable1', $nbre);
            undergrove::$instance->addPendingTarget($this->player_id, "Champi38", "Champi38SecondAbsorbStep2", $parg1);
