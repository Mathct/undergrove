...
class Champi35 extends Champi
{
    ...
    public function init($parg1, $parg2, $varg1, $varg2)
    {
        ...
        if ($parg1 != null)
        {
            ...
            undergrove::$instance->notifyAllPlayers("message",clienttranslate( '${player_name} activated ${name1} and copies ${name2}' ), array(
                ...
                'name2' => $this->listechampi[35]["name"],   //////////// changer le type
        ...
        {
            self::DbQuery( "UPDATE `champignon` set `carbone` = `carbone` + 2  WHERE `card_type` = 35" );        //////////// changer le type et nbre carbone
            undergrove::$instance->notifyAllPlayers("message",clienttranslate( '${player_name} activated ${name}' ), array(

                'i18n' => array( 'name'),
                'player_name' => $this->player_name,
                'name' => $this->listechampi[35]["name"],   //////////// changer le type
        ...
        undergrove::$instance->addPendingTarget($this->player_id, "Champi35", "Champi35Step1");
    }

    public function argChampi35Step1($parg1, $parg2)
    {
        $ret = array();
        $ret["selectable"] = array();
        $ret['buttons'] = array();
    ...
    public function Champi35Step1($parg1, $parg2, $varg1, $varg2)
    {
        
        undergrove::$instance->addPendingTarget($this->player_id, "Champi35", "Champi35Step2", $varg1);
    }

    public function argChampi35Step2($parg1, $parg2)
    {
        $ret = array();
        $ret["selectable"] = array();
        $ret['buttons'] = array();
    ...
    public function Champi35Step2($parg1, $parg2, $varg1, $varg2)
    {
        ...
        foreach ($recupminisquare as $id)
        {
            ...
            if (($explodeminisquare[1]==$explodesquare[1]) && ($explodeminisquare[2]==$explodesquare[2]) && ($explodeminisquare[3]==$explodesemi[1]) && ($explodeminisquare[4]==$explodesemi[2]))
            {
                ...
                undergrove::$instance->addPendingTarget($this->player_id, "Champi35", "Champi35SecondAbsorb", $parg1);
        ...
        if ($absorb == 0)
        {
            ...
            undergrove::$instance->addPendingTarget($this->player_id, "Champi35", "Champi35Step3", $parg1, $varg1);
    ...
    function argChampi35Step3($parg1, $parg2)
{
    $ret = array();
    $ret["selectable"] = array();
    $ret['buttons'] = array();
...
function Champi35Step3($parg1, $parg2, $varg1, $varg2)
{
    ...
    else
    {
        $nbre=undergrove::$instance->getGameStateValue('variable1')+1;
        undergrove::$instance->setGameStateValue('variable1', $nbre);
        undergrove::$instance->addPendingTarget($this->player_id, "Champi35", "Champi35Step3", $parg1, $parg2);
    ...
    public function argChampi35SecondAbsorb($parg1, $parg2)
    {
        $ret = array();
        $ret["selectable"] = array();
        $ret['buttons'] = array();
    ...
    public function Champi35SecondAbsorb($parg1, $parg2, $varg1, $varg2)
    {
        ...
        if (($varg1 != NULL) && ($varg1 != "Pass"))
        {
            undergrove::$instance->addPendingTarget($this->player_id, "Champi35", "Champi35SecondAbsorbStep2", $varg1);

        }
        
    }

    public function argChampi35SecondAbsorbStep2($parg1, $parg2)
    {
        $ret = array();
        $ret["selectable"] = array();
        $ret['buttons'] = array();
    ...
    public function Champi35SecondAbsorbStep2($parg1, $parg2, $varg1, $varg2)
    {
        undergrove::$instance->setGameStateValue('variable1', 0);
        undergrove::$instance->setGameStateValue('variable2', 0);
        ...
        if ($absorb == 0)
        {
            ...
            undergrove::$instance->addPendingTarget($this->player_id, "Champi35", "Champi35SecondAbsorbStep3", $parg1, $varg1);
    ...
    function argChampi35SecondAbsorbStep3($parg1, $parg2)
{
    $ret = array();
    $ret["selectable"] = array();
    $ret['buttons'] = array();
...
function Champi35SecondAbsorbStep3($parg1, $parg2, $varg1, $varg2)
{
    ...
    else
    {
        $nbre=undergrove::$instance->getGameStateValue('variable1')+1;
        undergrove::$instance->setGameStateValue('variable1', $nbre);
        undergrove::$instance->addPendingTarget($this->player_id, "Champi35", "Champi35SecondAbsorbStep3", $parg1, $parg2);
