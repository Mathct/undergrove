...
class Champi37 extends Champi
{
    ...
    public function init($parg1, $parg2, $varg1, $varg2)
    {
        ...
        if ($parg1 != null)
        {
            ...
            undergrove::$instance->notifyAllPlayers("message",clienttranslate( '${player_name} activated ${name1} and copies ${name2}' ), array(
                ...
                'name2' => $this->listechampi[37]["name"],   //////////// changer le type
...

        {
            ...
            undergrove::$instance->notifyAllPlayers("message",clienttranslate( '${player_name} activated ${name}' ), array(
                ...
                'i18n' => array( 'name'),
                'player_name' => $this->player_name,
                'name' => $this->listechampi[37]["name"],   //////////// changer le type
        ...
        undergrove::$instance->addPendingTarget($this->player_id, "Champi37", "Champi37Step1");
    }

    public function argChampi37Step1($parg1, $parg2)
    {
        $ret = array();
        $ret["selectable"] = array();
        $ret['buttons'] = array();
    ...
    public function Champi37Step1($parg1, $parg2, $varg1, $varg2)
    {
        ...
        foreach ($recupminisquare as $id)
        {
            ...
            if (($explodeminisquare[1]==$explodesquare[1]) && ($explodeminisquare[2]==$explodesquare[2]) && ($explodeminisquare[3]==$explodesemi[1]) && ($explodeminisquare[4]==$explodesemi[2]))
            {
                ...
                undergrove::$instance->addPendingTarget($this->player_id, "Champi37", "Champi37SecondAbsorb", $varg1);
        ...
        if ($absorb == 0)
        {
            ...
            undergrove::$instance->addPendingTarget($this->player_id, "Champi37", "Champi37Step2", $varg1);
    ...
    function argChampi37Step2($parg1, $parg2)
    {
        $ret = array();
        $ret["selectable"] = array();
        $ret['buttons'] = array();
    ...
    function Champi37Step2($parg1, $parg2, $varg1, $varg2)
    {
    ...
    
        {
            ...
            undergrove::$instance->addPendingTarget($this->player_id, "Champi37", "Champi37SecondAbsorb", $parg1);
        ...
        else
        {
            $nbre=undergrove::$instance->getGameStateValue('variable1')+1;
            undergrove::$instance->setGameStateValue('variable1', $nbre);
            undergrove::$instance->addPendingTarget($this->player_id, "Champi37", "Champi37Step2", $parg1);
        ...
        public function argChampi37SecondAbsorb($parg1, $parg2)
    {
        $ret = array();
        $ret["selectable"] = array();
        $ret['buttons'] = array();
    ...
    public function Champi37SecondAbsorb($parg1, $parg2, $varg1, $varg2)
    {
        ...
        if ($absorb == 0)
        {
            ...
            undergrove::$instance->addPendingTarget($this->player_id, "Champi37", "Champi37SecondAbsorbStep2", $varg1);
    ...
    function argChampi37SecondAbsorbStep2($parg1, $parg2)
    {
        $ret = array();
        $ret["selectable"] = array();
        $ret['buttons'] = array();
    ...
    function Champi37SecondAbsorbStep2($parg1, $parg2, $varg1, $varg2)
    {
        ...
        else
        {
            $nbre=undergrove::$instance->getGameStateValue('variable1')+1;
            undergrove::$instance->setGameStateValue('variable1', $nbre);
            undergrove::$instance->addPendingTarget($this->player_id, "Champi37", "Champi37SecondAbsorbStep2", $parg1);
